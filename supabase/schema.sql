...
-- ============================================================================
-- CONTACTS — vendors / customers tied to payables and receivables
-- ============================================================================
...
-- ============================================================================
-- CONTRACTS — payment agreements with a contact (vendor)
-- ============================================================================
...
-- inventory.under_maintenance — items currently out for repair
...
create index if not exists inventory_maintenance_idx
  on public.inventory (organization_id) where under_maintenance = true;
